...
<body>
    ...
    <div id="main">
        ...
        <!--__________________request book_______________ -->
        ...
        if (isset($_POST['submit1'])) {
            if (isset($_SESSION['login_user'])) {
                ...
                $query = "INSERT INTO issue_book (username, bid, approve, issue, `return`) VALUES ('$username', '$bid', 'Pending', '', '')";

                if (mysqli_query($db, $query)) {
                    echo "<script>window.location='request.php';</script>";
                } else {
                    echo "<script>alert('Error in requesting the book.');</script>";
                }
            } else {
                echo "<script>alert('You must log in to request a book.');</script>";
            }
        }
